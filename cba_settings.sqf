...
force force acex_field_rations_hungerSatiated = 2.00341;
force force acex_field_rations_nearDepletedConsequence = 0;
force force acex_field_rations_terrainObjectActions = true;
force force acex_field_rations_thirstQuenched = 2.00341;
...
force force ace_hearing_explosionDeafnessCoefficient = 0.25;
...
force force ace_medical_bleedingCoefficient = 1.0;
...
force force ace_medical_ivFlowRate = 2.0;
...
ace_viewdistance_viewDistanceAirVehicle = 3500;
ace_viewdistance_viewDistanceLandVehicle = 3500;
ace_viewdistance_viewDistanceOnFoot = 3500;
...
force force AVS_EnableVoiceSounds = true;
...
force force cScripts_Settings_AllowAILoadouts = false;
...
force force cScripts_Settings_useFilteredArsenal = true;
...
force force WBK_DeathAnimMod_Hit_Chance = "75";
force force WBK_DeathAnimMod_Hit_Chance_PLR = "10";
...
// FoxHole
force force J3FF_FHcover = "10";
force force J3FF_FHcustomItem = false;
force force J3FF_FHdepth = "2";
force force J3FF_FHdig = "15";
...
force force WBK_IA_W = false;

// K9 Companion
force force K9Companion_HealTime = 30;
force force K9Companion_MaxDistance = 2500;
force force K9Companion_ReturnHomeTime = 15;
force force K9Companion_TimeBeforeForcedReturn = 120;
...
force force kat_misc_IFAKFourthSlotItem = "[['kat_chestSeal', 2], ['kat_ncdKit', 1], ['kat_guedel', 1]]";
...
force force kat_vitals_basicDiagnosticTime = 15;
force force kat_vitals_enableBasicDiagnostic = false;
...
// Modules Enhanced
meh_common_ModuleMarkerColor = [1,0.41,0.71,1];
meh_common_ModuleMarkerDistanceLimit = 750;
meh_common_ModuleMarkerHide = false;

// PD: Surrender
force force PD_SURRENDER_ALLOWFLEE_MAX = 0.2;
force force PD_SURRENDER_ALLOWFLEE_MIN = 0.05;
force force PD_SURRENDER_AUTOCLEANUP_DIST = 100;
force force PD_SURRENDER_AUTOCLEANUP_SECS = 180;
force force PD_SURRENDER_AutoDelete = true;
force force PD_SURRENDER_COOLDOWN = 15;
force force PD_SURRENDER_DEBUG = false;
force force PD_SURRENDER_INCLUDE_ALLIES = true;
force force PD_SURRENDER_MIN_ENEMY_DIST = 0;
force force PD_SURRENDER_OUTNUMBER_RATIO = 3;
force force PD_SURRENDER_PLAYER_NEAR_DIST = 50;
force force PD_SURRENDER_Player_side_no_surrender = true;
force force PD_SURRENDER_RADIUS = 150;
force force PD_SURRENDER_REQUIRE_LOS = true;
force force PD_SURRENDER_REQUIRE_PLAYER_NEAR = true;
force force PD_SURRENDER_STAGGER_MAX = 4;
force force PD_SURRENDER_USE_RATIO = true;
force force PD_SURRENDER_VEHICLE_RULE = "immobilizedOnly";

// Pinned Down
force force Mikeys_AISkill_cap = 0.35;
force force Mikeys_AISup_burstSec = 1.5;
force force Mikeys_AISup_capSec = 12;
force force Mikeys_AISup_distance = 15;
force force Mikeys_AISup_halflife = 5;
force force Mikeys_AISup_strength = 1;
force force Mikeys_AISupEnable = true;
force force Mikeys_AIUseSuppressiveFire = true;
force force Mikeys_PLAYER_SUP_ENABLED = true;
force force MKY_BRAIN_HYBRID = true;
force force PD_AIM_DMG_MULT = 3;
force force PD_AIM_EASE = 0.07;
force force PD_AIM_MAX = 12;
force force PD_AIM_SUP_MULT = 2.2;
force force PD_BLINK_COOLDOWN = 2.2;
force force PD_BLINK_ENABLE = false;
force force PD_CAMSHAKE_ENABLE = true;
force force PD_CAMSHAKE_MULT = 1.25;
force force PD_DECAY_HALFLIFE = 1.1;
force force PD_EVENT_LATCH = 0.25;
force force PD_MIN_IMPULSE_UP = 0.02;
force force PD_RECOIL_STRESS_MULT = 0.91;
force force PD_RED_CAP = 0.25;
force force PD_SUP_FLOOR = 0.08;
force force PD_TICK = 0.5;
force force PD_TUNNEL_CAP = 0.7;
force force PD_TUNNEL_CD = 0.35;
force force PD_TUNNEL_FADE = 1.15;
force force PD_TUNNEL_ONSET = 0.05;
force force PD_VISUAL_MODE = 1;

// Realistic Airborne
force force RA_AutoEquipCheck = true;
force force RA_ChuteClass = "";
force force RA_DebugMode = false;
force force RA_MaxAltitude = 0;
force force RA_MinAltitude = 100;
force force RA_NODsFriendly = true;
force force RA_StaticEquipped = true;

// TFAR - Clientside settings
TFAR_curatorCamEars = false;
TFAR_default_radioVolume = 1.21809;
...
force force TFAR_setting_externalIntercomWirelessHeadgear = "USP_OPS_FASTXP";
...
force force TFAR_Teamspeak_Channel_Name = "Task Force Radio";
force force TFAR_Teamspeak_Channel_Password = "SantoyoHotMic";
...
force force tsp_cba_animate_carry = 2;
...
force force tsp_cba_animate_drop_ace = true;
force force tsp_cba_animate_drop_infinite = true;
...
force force tsp_cba_breach_lock_door = 0.701618;
force force tsp_cba_breach_lock_house = 0.751836;
...
// zen_faction_filter_0_kfc_ps_bgf_Belarusian_Ground_Forces = true;
// zen_faction_filter_0_kfc_ps_chdkz_ChDKZ = true;
// zen_faction_filter_0_kfc_ps_rgf_Russian_Ground_Forces = true;
// zen_faction_filter_0_kfc_ps_tlf_Takistani_Liberation_Front = true;
...
// zen_faction_filter_1_kfc_ps_baf_British_Army = true;
// zen_faction_filter_1_kfc_ps_bw_Bundeswehr = true;
// zen_faction_filter_1_kfc_ps_usa_US_Army = true;
// zen_faction_filter_1_kfc_ps_usmc_d_United_States_Marine_Corps = true;
// zen_faction_filter_1_kfc_ps_usmc_w_United_States_Marine_Corps = true;
...
// zen_faction_filter_2_kfc_ps_cdf_Chernarus_Defense_Force = true;
// zen_faction_filter_2_kfc_ps_ldf_Livonian_Defense_Forces = true;
// zen_faction_filter_2_kfc_ps_nta_New_Takistani_Army = true;
